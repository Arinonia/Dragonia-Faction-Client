...
import fr.arinonia.gui.GuiFadeInOut;
import fr.arinonia.gui.GuiLoadingScreen;
...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback {
    ...
    protected void actionPerformed(final GuiButton button) {
        if (button.id == 0) {
            this.mc.displayGuiScreen(new GuiFadeInOut(this, new GuiOptions(this, Minecraft.getMinecraft().gameSettings), 1000, 0));
        } else if (button.id == 1) {
            ...
            this.mc.displayGuiScreen(new GuiFadeInOut(this, new GuiLoadingScreen(), 1000, 0));
        }
